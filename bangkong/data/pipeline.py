...
class DataPipeline:
    ...
    def load_data(self, data_path: str, data_type: str = "text") -> Any:
        ...
        if data_type == "text":
            ...
            return self._load_parquet_data(resolved_path)
        else:
    ...
    def _load_parquet_data(self, path) -> List[Dict]:
        """
        ...
        try:
            ...
            raise ImportError("pandas is required to load Parquet files. Install it with: pip install pandas")
